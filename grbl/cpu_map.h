...
#define cpu_map_h
  ...
  #define STEP_BIT_1 3  // Z Step - Pin D46 (swapped with Y)
  #define STEP_BIT_2 6  // Y Step - Pin A6 (swapped with Z)
  ...
  #define DIRECTION_BIT_1 1 // Z Dir - Pin D48 (swapped with Y)
  #define DIRECTION_BIT_2 7 // Y Dir - Pin A7 (swapped with Z)
  ...
  #define STEPPER_DISABLE_BIT_1 0 // Z Enable - Pin A8 (swapped with Y)
  #define STEPPER_DISABLE_BIT_2 2 // Y Enable - Pin A2 (swapped with Z)
  ...
  #define MIN_LIMIT_BIT_1 3 // Z Limit Min - Pin D18 (swapped with Y)
  #define MIN_LIMIT_BIT_2 1 // Y Limit Min - Pin D14 (swapped with Z)
  ...
  #define MAX_LIMIT_BIT_1 2 // Z Limit Max - Pin D19 (swapped with Y)
  #define MAX_LIMIT_BIT_2 0 // Y Limit Max - Pin D15 (swapped with Z)
